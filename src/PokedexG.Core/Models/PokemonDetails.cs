// RECONSTRUCTION 2026-07-23 — propriétés d'origine réactivées (elles étaient commentées quand
// la page de détails est passée sur la seconde pile EF, abandonnée ici). Chaque nom correspond
// à l'alias de colonne de get-pokemon_clean.txt, écrit par l'auteur d'origine. Rien d'inventé.
