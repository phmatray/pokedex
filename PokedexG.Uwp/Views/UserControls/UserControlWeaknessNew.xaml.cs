...
{
    public sealed partial class UserControlWeaknessNew
    {
        public UserControlWeaknessNew()
        {
            InitializeComponent();
        ...
        //    "Damage", typeof(DamageType), typeof(UserControlWeaknessNew), new PropertyMetadata(default(DamageType)));
        ...
        private static readonly DependencyProperty DamageTypeNameProperty = DependencyProperty.Register(
            "DamageTypeName", typeof(string), typeof(UserControlWeaknessNew), new PropertyMetadata(default(string)));
        ...
        private static readonly DependencyProperty DamageFactorProperty = DependencyProperty.Register(
            "DamageFactor", typeof(string), typeof(UserControlWeaknessNew), new PropertyMetadata(default(string)));
        ...
        private static readonly DependencyProperty DamageFactorBackgroundProperty = DependencyProperty.Register(
            "DamageFactorBackground", typeof(SolidColorBrush), typeof(UserControlWeaknessNew), new PropertyMetadata(default(SolidColorBrush)));
        ...
        private static readonly DependencyProperty DamageFactorForegroundProperty = DependencyProperty.Register(
            "DamageFactorForeground", typeof(SolidColorBrush), typeof(UserControlWeaknessNew), new PropertyMetadata(default(SolidColorBrush)));
