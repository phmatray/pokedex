...
namespace PokedexG.Uwp
{
    ...
    {
        public const string SqlDirectory = "ms-appx:///Services/VeekunServices/SqlQueries";
        ...
        public const int VersionGroupsIdXy = 15; // x-y
        public const int DefaultVersionGroupsId = 16; // omega-ruby-alpha-sapphire
        public const int DefaultMoveMethodId = 1; // By Level
    }
}